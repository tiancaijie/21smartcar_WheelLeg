...
VMC_Data_Type L_leg,R_leg;
Bint16_Union Left_Speed = {0};
Bint16_Union Right_Speed = {0};
float Height_Init = 0.039;
float L_Height = 0.039;
float R_Height = 0.039;
float XOffset = 0.0002;
float LXc[2] = {0};
float RXc[2] = {0};
