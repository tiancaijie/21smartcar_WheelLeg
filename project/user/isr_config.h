...
#define CCU6_1_CH0_ISR_PRIORITY 55
...
#define EXTI_CH3_CH7_INT_PRIO   30                  // 定义ERU通道3和通道7中断优先级 同上
...
#define UART0_RX_INT_PRIO       80                  // 定义串口0接收中断优先级 优先级范围1-255 越大优先级越高 与平时使用的单片机不一样
