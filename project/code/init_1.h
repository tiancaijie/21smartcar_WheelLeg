...
#define LeftF_Init                      770*6 - 100*6//(LeftF_CENTER+500)*6   //90
#define LeftB_Init                      765*6 + 100*6//(LeftB_CENTER-500)*6
#define RightF_Init                     710*6 + 100*6//(RightF_CENTER-500)*6
#define RightB_Init                     750*6 - 100*6//(RightB_CENTER+500)*6
